...
const JSON_PLAN_PURPOSES = new Set([
  "plan_research",
  "plan_clarify",
  "plan_research_synthesis",
  "plan_clarify_synthesis",
  "plan_research_structure_repair",
  "plan_clarify_structure_repair"
]);
...
function normalizeToolCalls(value) {
  ...
  return value.map((call) => {
    ...
    const name = cleanIdentifier(call?.function?.name, 64);
